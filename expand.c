...
/*   Updated: 2025/04/03 20:21:53 by maissat          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//void	expand_file(t_file *file, t_data *data)
//{
//	char	*expanded;

//	if (file->mode != HEREDOC)
//		expanded = expand_string(file->path, data);
//	else if (ft_strlcmp(file->path, "$?") == 0)
//		expanded = ft_itoa(data->exit_status);
//	else
//		expanded = expand_string(file->path, data);
//	file->path = expanded;
...
//void	expand_arg(char **args, int i, t_data *data)
//{
//	char	*expanded;
...
//		i = -1;
//		while (current_cmd->args && current_cmd->args[++i])
//			expand_arg(current_cmd->args, i, data);
//		current_file = current_cmd->files;
//		while (current_file)
//		{
//			expand_file(current_file, data);
//			current_file = current_file->next;
//		}
//		current_cmd = current_cmd->next;
//	}
